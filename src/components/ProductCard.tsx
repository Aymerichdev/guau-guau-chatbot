...
export function ProductCard({ product, onSelect }: ProductCardProps) {
  return (
    <motion.article
      ...
      whileHover={{ y: -4 }}
      className="group flex flex-col rounded-xl border border-border bg-card p-5 shadow-[var(--shadow-card)] transition-[border-color,box-shadow] duration-200 hover:border-primary hover:shadow-[var(--shadow-card-hover)]"
    >
